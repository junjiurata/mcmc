...
plot(0,0, xlim=c(0,nrow(od.err)), ylim=c(0,10), xlab="Number of Iteration", ylab="Error of Mean Square (Origin)", col="white")
...
#plot(0,0, xlim=c(800,1000), ylim=c(0,10), xlab="Number of Iteration", ylab="Error of Mean Square (Origin)", col="white")
plot(0,0, xlim=c(0,nrow(od.err)), ylim=c(0,10), xlab="Number of Iteration", ylab="Error of Mean Square (Destination)", col="white")
...
plot(0,0, xlim=c(0,nrow(od.err)), ylim=c(16000,21000), xlab="Number of Iteration", ylab="Energy", col="white")
...
#png(filename = "cost2.png", width=1100, height=500)
#plot(0,0, xlim=c(0,25000), ylim=range(cost), xlab="Number of Iteration", ylab="Total travel cost", col="white")
plot(0,0, xlim=c(0,nrow(od.err)), ylim=c(3000000,4700000), xlab="Number of Iteration", ylab="Total travel cost", col="white")
...
plot(0,0, xlim=c(0,nrow(od.err)), ylim=c(sumod-70, sumod+80), xlab="Number of Iteration", 
